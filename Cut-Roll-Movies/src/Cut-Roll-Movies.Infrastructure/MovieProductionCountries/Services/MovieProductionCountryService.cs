namespace Cut_Roll_Movies.Infrastructure.MovieProductionCountries.Services;
...
public class MovieProductionCountryService : IMovieProductionCountryService
{
    ...
    public async Task<PagedResult<Movie>> GetMoviesByCountryIdAsync(MovieSearchByCountryDto? dto)
    {
        if (dto == null)
